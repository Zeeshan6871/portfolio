          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/Koshur1504/Code-Kathan-2345"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <a
                  href="https://kathan-news.netlify.app/"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="body">
              <img
                ...
                alt="kathanNews"
              />
              <h3>Innovative Online News Application Development</h3>
              <p>
                {" "}
                Contributed to the development of an innovative online news
                application, utilizing JavaScript, Redux, Git, React, HTML5,
                CSS3, and TypeScript. Implemented user and admin registration,
                authentication, and profile management functionality. Designed a
                responsive web interface to ensure a seamless user experience
                across devices.{" "}
              </p>
            </div>
            <footer>
              ...
              <ul className="tech-list">
                {" "}
                <li>React</li> <li>Type Script</li> <li>Java Script</li>{" "}
              </ul>{" "}
            </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="fadeInUp">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/itiaditi/debug-adept-0123"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={githubIcon} alt="Visit site" />{" "}
                ...
                <a
                  href="https://debug-adept-0123.vercel.app/snapBasket/index.html"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={externalLink} alt="Visit site" />
            ...
            <div className="body">
              ...
              />
              <h3>
                SnapBasket : User-Friendly Online Grocery Shopping Website
              </h3>
              <p>
                Played a pivotal role in SnapBasket's development, leveraging
                JavaScript, HTML5, and CSS3 to create an intuitive interface.
                Key features, including login/signup, product descriptions, and
                checkout, were expertly implemented. Collaborated with a dynamic
                team of 4 to design and develop the platform, with a focus on
